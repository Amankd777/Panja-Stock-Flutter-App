...
class Constants {
  ...
  static Color darkPrimary = const Color(0xff10151E);

  static Color lightAccent = const Color(0xff39FB97);

  static Color darkAccent = const Color(0xff39FB97);

  static Color lightBG = const Color(0xfff3f4f9);
  static Color darkBG = const Color(0xff10151E);
